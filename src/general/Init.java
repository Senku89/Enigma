...
public class Init{
	...
	public static String texteIntro = "Pour cela vous allez passer par 3 mini-jeux qui vous permettront de gagner des indices qui vous aideront au moment de décoder Enigma :\n" +
